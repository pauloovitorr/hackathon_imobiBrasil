          ...
          if($tipo_contrato != 'Venda'){
            ...
            if($nome != '' && $tmp !=''){
                move_uploaded_file($tmp , $caminho);
                    ...
                    $sql2 = "INSERT INTO documentos (dt_criacao, tipo_doc, cod_adm, path, nome, codigo_contrato) VALUES (NOW(), 'Contrato de edição', $cod_adm, '$caminho', '$nome', $cod_contrato  ) ";

                $resp = $connexao->query($sql2);
...
<head>
  ...
  <link rel="shortcut icon" href="https://admin01.imobibrasil.net/imobiliarias/imagens/imobibrasil.ico" />
  ...
  <link href="./styles/jquery.modal.min.css" rel="stylesheet" type="text/css" />
...
<body>
  <header>
    <div class="container" id="ct_topo1">
      <div class="logo">
        <a href="https://admin01.imobibrasil.net/imobiliarias/inicial.php" title="Inicial"><img src="./img/logo.png" alt="imobibrasil" /></a>
      </div>
        ...
        <div id="cssmenu">
          ...
          <ul>
            <li class="active has-sub" id="menuItem_conf">
              <a href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php#"><span>Configurações</span></a>
              <ul>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_gerais.php">Configurações Gerais</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_menus_locacaovenda.php">Busca Rápida</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/cadastro_usuarios_listar.php">Usuários Adicionais</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/cadastro_senha.php">Senha Principal</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="btnAbrirNovidades">Novidades</a>
                </li>
              </ul>
            </li>

            <li class="active has-sub" id="menuItem_design">
              <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_modelo.php"><span>Design</span></a>
              <ul>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_modelo.php">Modelos</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_gerais_imagens_alt.php?cod=1">Logotipo</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_gerais_imagens.php">Banners</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/configuracoes_gerais_paginas.php">Páginas</a>
                </li>
              </ul>
            </li>

            <li class="active has-sub" id="menuItem_CRM">
              <a href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php#"><span>CRM Imóveis</span></a>
              <ul>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/imovel_inserir.php#topo">Imóveis: Incluir</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/imovel_listar.php">Imóveis: Listar</a>
                </li>

                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/clientes_listar.php">Clientes</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/imoveis-compativeis.php">Imóveis Compatíveis</a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/portais_parceiros_listar.php">Integrações Portais</a>
                </li>
              </ul>
            </li>

            <li class="active has-sub" id="menuItem_Modulos">
              <a href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php#"><span>Módulos</span></a>
              <ul>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_agendacomp_listar.php">Agenda</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/areaprivada_inicial.php">Área Privada</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/bairros_especial_listar.php">Bairros que Amamos</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_catalogo_imoveis_listar.php">Catálogo de Imóveis</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/chaves_mod_controledechaves.php">Controle de Chaves</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/documentos-gerenciador.php">Documentos</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/api_dwv_configuracoes.php">DWV</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_formularios_inicial.php">Formulários</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/contratos-listar.php">Gerar Contratos</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/atend_listar.php">Gerenciador de Atendimentos</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/hotsite_listar.php">HotSite</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/ferramentas_conversao_listar.php">Pop-up Conversão</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_social-pixel-post.php">Social Pixel</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_imobr-negocios.php">imoBR Negócios</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/orulo_listar_imoveis.php">Órulo</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/mod_whatsapp_inicial.php">WhatsApp Lead</a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php" class="menu-add-modulo">Adicionar Módulo</a>
                </li>
              </ul>
            </li>

            <li class="active has-sub" id="menuItem_Relatorios">
              <a href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php#"><span>Relatórios</span></a>
              <ul>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/relatorios-indicadores-listar.php"><span>Indicadores</span></a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/relatorios_imoveis.php"><span>Imóveis</span></a>
                </li>
                <li>
                  <a href="https://admin01.imobibrasil.net/imobiliarias/relatorios_clientes.php"><span>Clientes</span></a>
                </li>
              </ul>
            </li>

            <li class="active has-sub" id="menuItem_Msg">
              <a href="https://admin01.imobibrasil.net/imobiliarias/caixa-mensagem-listar.php" id="cssmenumsg"><span>Mensagens</span></a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container" id="ct_topo2">
      <div class="tp-submenu-partemenu">
        <div>
          <ul style="display: flex; align-items: center">
            <li>
              <a href="https://admin01.imobibrasil.net/imobiliarias/inicial.php" target="_self">Inicial</a>
            </li>
            <li>
              <a id="abrir_modal_suporte" href="https://admin01.imobibrasil.net/imobiliarias/modulos-listar.php#" target="_self">Suporte</a>
            </li>
            <li>
              <i class="fa fa-graduation-cap" aria-hidden="true" style="margin-right: 5px"></i><a href="https://ajuda.imobibrasil.com.br/" target="_blank"><span class="ct2_verSite">Tutoriais de </span>Ajuda</a>
            </li>
            <li>
              <i class="fa fa-television" aria-hidden="true"></i> &nbsp;<a href="http://localhost/projeto_financiamento_imobiliario/tela_imovel.php" target="_blank"><span class="ct2_verSite">Visualizar</span>
                <span>Site</span></a>
            </li>

            <li class="last">
              <i class="fa fa-sign-out" aria-hidden="true"></i> &nbsp;<a href="https://admin01.imobibrasil.net/imobiliarias/identificacao.php?acao=sair" title="Sair"><span>Sair</span></a>
            </li>

            <li class="last busca_aprimorada_li_botao" style="display: block">
              <form action="javascript:" style="margin-bottom: 0px">
                <div class="search-bar">
                  <input type="search" class="input-search" id="nova_busca_aprimorada_busca_ajax" style="margin-left: -23px" name="search" autocomplete="off" pattern=".*\S.*" required="" />
                  <button class="search-btn" type="submit" style="border: none !important">
                    <span>Busca</span>
                  </button>
                </div>
                <div style="position: relative; width: 100%">
                  <input type="hidden" name="campos_busca_gerados[]" id="campos_busca_gerados" value="" />
                  <div id="paginas-exibicao__linha__input__resultado_topo" style="
                        display: flex;
      ...
      <div class="tp-submenu-persona">
        <div class="tp-submenu-persona_User">
          <a href="https://admin01.imobibrasil.net/imobiliarias/cadastro_senha.php?pag=img" class="tp-submenu-persona-Link">
            <div class="tp-submenu-persona_User_Img">
              <img src="./img/20210813114151367.png" border="0" /><img src="./img/20210813114151367.png" id="tp_submenu-persona_User_Img-2" />
            </div>
          </a>
      ...
      <style>
        ...
        .container-search-busca-mobile:focus-within+.container-background-modal-search-busca-mobile {
          display: block;
        }

        .container-search-busca-mobile:focus-within+.container-fechar-search-busca-mobile {
          display: block;
        }

        .container-search-busca-mobile:focus-within+.tp-submenu-novidades__box {
          display: none !important;
        }

        .container-search-busca-mobile:focus-within+.tp-submenu-notificacao__box {
          display: none !important;
        }
          ...
          <div class="tp-submenu-notificacao__box">
            <a class="tp-submenu-persona-Link">
              <div class="tp-submenu-persona_User_Img tp-bell-pulse">
                <i class="fa-regular fa-bell tp-submenu-bell notificacoes-nao-lidas"></i>
          ...
          <div class="tp-central-notificacao-dropdown-body">
            <div class="notify-details notify-nao-lido">
              <div data-balao="Imóveis" compatíveis="" class="balao notify-details-icone">
                <a href="https://admin01.imobibrasil.net/imobiliarias/imoveis-compativeis.php">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="695345" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Agenda" class="balao notify-details-icone">
                <a href="https://admin01.imobibrasil.net/imobiliarias/mod_agendacomp_listar.php">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="692243" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Mensagens" class="balao notify-details-icone">
                <a href="https://admin01.imobibrasil.net/imobiliarias/caixa-mensagem-listar.php">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="681297" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Mensagens" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="678789" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Mensagens" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="675864" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Imóveis" Compatíveis="" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="667535" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Imóveis" Compatíveis="" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="666443" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Imóveis" Compatíveis="" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="664085" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Mensagens" class="balao notify-details-icone">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="664084" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa-solid fa-circle"></i></span>
              </div>
            </div>
            <div class="notify-details notify-nao-lido">
              <div data-balao="Negócios" class="balao notify-details-icone">
                <a href="https://admin01.imobibrasil.net/imobiliarias/negocios_historico.php">
              ...
              <div class="notify-details-corpo">
                ...
                <span data-codigo="660866" data-balao="Marcar" lido="" class="balao marcar-lido"><i class="fa fa-circle"></i></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <link href="./styles/central-notificacoes-topo.css" type="text/css" rel="stylesheet" />
      <script type="text/javascript" src="./scripts/sweetalert2@11.js" charset="utf-8"></script>
            ...
            <div class="modal-contatos-body">
              <div class="modal-contatos-buttons">
                <div class="modal-contatos-buttons-group">
                  <a href="https://admin01.imobibrasil.net/imobiliarias/suporte.php" class="modal-btn-suporte">
                  ...
                  <a target="_blank" href="https://web.whatsapp.com/send?phone=5518988227436&amp;text=Ol%C3%A1,%20preciso%20de%20suporte.%20Meu%20site%20%C3%A9:%20www.imobbrasil.com.br" class="modal-btn-whatsapp">
              ...
              <div class="modal-contatos-lista-container">
                <ul class="modal-contatos-lista">
                  <li>
                    <a href="tel:1832220557" title="Telefone (18) 3222-0557">(18) <span> 3222-0557</span> - PRESIDENTE PRUDENTE /
                      SP</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a target="_blank" href="https://web.whatsapp.com/send?phone=5518988227436&amp;text=Ol%C3%A1,%20preciso%20de%20suporte.%20Meu%20site%20%C3%A9:%20www.imobbrasil.com.br" title="WhatsApp" rel="noreferrer">(18) <span>98822-7436</span>
      ...
      <div class="modal-container" id="container-novidades">
        <div id="caixa-novidades" class="sidenav">
          <div class="top-side-nav">
            ...
            <div class="container-icons">
              <a href="javascript:void(0)" id="openFiltros" class="icon-search-novidade">
                <i class="fa fa-search" aria-hidden="true"></i></a>
              <a href="javascript:void(0)" id="closeNovidades" class="icon-close-novidade">×</a>
            </div>
          </div>
        </div>
        ...
        <div id="fitros-novidades" class="sidenav2">
          <div class="top-side-nav">
            ...
            <div class="container-icons">
              <a href="javascript:void(0)" id="closeFiltros" class="icon-close-novidade">×</a>
            </div>
          </div>

          <div class="container-filtro">
            <a href="javascript:void(0)" class="filtro-novidades" data-filtro="TODOS">Todos</a><a href="javascript:void(0)" class="filtro-novidades" data-filtro="NOVIDADES">Novidades</a><a href="javascript:void(0)" class="filtro-novidades" data-filtro="MELHORIAS">Melhorias</a><a href="javascript:void(0)" class="filtro-novidades" data-filtro="PODCAST">Podcast</a>
          </div>
        </div>
      </div>
      ...
      <div class="conteudo">
        ...
        <div class="revisa">
          ...
          <div class='form_compradores'>
            ...
            <form method="post" id="cadastrarcomprador" enctype="multipart/form-data"   >

              <div style='display: flex; justify-content:space-between; border:none'>
                    <label style="font-size: 1.0rem;" for="tipo_contrato">Tipo de Contrato</label> <br>

                    <select name="tipo_contrato" id="tipo_contrato" style='font-size: 1.0rem;' required>

                        <?php 
                         if($dados_contrato['tipo'] == 'Venda'){
                            echo '<option value="Venda">' . $dados_contrato['tipo'] . '</option>';
                            echo '<option value="Distrato">Distrato</option>';
                            echo '<option value="Recisão">Recisão</option>';
                        }
                        elseif($dados_contrato['tipo'] == 'Distrato'){
                            echo '<option value="Distrato">' . $dados_contrato['tipo'] . '</option>';
                            echo '<option value="Venda">Venda</option>';
                            echo '<option value="Recisão">Recisão</option>';
                        }
                        else {
                            echo '<option value="Recisão">' . $dados_contrato['tipo'] . '</option>';
                            echo '<option value="Venda">Venda</option>';
                            echo '<option value="Distrato">Distrato</option>';
                        }
...
<!-- Pauloo -->
              ...
              <div class="inputfile">
                ...
                <div class="pular" style="background-color:#0b5dd9;">
                    <p >Adicionar o contrato comprobatório </p>
                </div>
                ...
                <div class="pai_inputfile">
                    <input type="file" class="custom-file-input" accept=".pdf, .doc, .docx" id="fileInputEdit"  name="contratoedit">
                    <p class="custom-button" style="background-color:#0b5dd9;" onclick="document.getElementById('fileInputEdit').click()">Selecionar Arquivos</p>
                </div>
            </div>



            <div style="border:none; width:50%; margin:0 auto;margin-top: 15px; display:flex; flex-direction:column;" >
                <label style="font-size: 1.0rem;" for="obs">Observações</label>
                <textarea style="outline-color: #18c721; width:100%; padding: 10px; font-size:1.0rem" name="obs" id="obs" cols="30" rows="8" required></textarea>
            </div>

            <div style="width: 14%;margin:auto; border:none">
                    <button style="width: 100%" class="btnss" type="submit">Salvar</button>
            </div>
  ...
  <div class="chatbox-wrapper-nps">
    <div class="chatbox-toggle-nps">
      <div style="
            ...
            font-size: 18px;
          ">
        <i style="transform: rotate(90deg)" class="fa-regular fa-face-smile"></i>
        Opinião
      </div>
    </div>
    ...
    <div class="chatbox-message-wrapper-nps">
      <div class="chatbox-message-content-nps">
        <div class="" style="position: relative">
          <div class="background-widget-nps" style="
                width: 100%;
                height: 230px;
          ...
          <div class="content-widget-nps">
            <div class="header-content-widget-nps flex flex-col z-10 ml-4 text-white">
              <div class="text-3xl mb-2" style="
                    margin-top: 15px;
                    user-select: none;
                    font-size: 19px;
                    line-height: 25px;
            ...
            <div class="border-0 border-t-4 border-green-500 rounded z-10 shadow-md" id="abrirchamado" style="margin-top: 15px">
              <div class="bg-white border border-t-0 rounded-t-none rounded-b flex flex-col">
                ...
                <div class="px-6 pab-4 flex flex-col items-start gap-3">
                  <span style="color: red; display: none" id="error-cm-envio"></span>

                  <span style="color: #039341; display: none" id="success-cm-envio"></span>

                  <div class="flex flex-row gap-1" style="
                        width: 100%;
                        justify-content: center;
                        align-items: center;
                        user-select: none;
                  ...
                  <div class="flex flex-col items-start gap-3" style="margin-top: 30px">
                    <label id="toggleIcon" class="" style="
                          cursor: pointer;
                          user-select: none;
                          font-weight: 400;
                          color: grey;
                  ...
                  <div class="flex flex-row gap-1" id="localTextarea" style="width: 100%; height: 0px">
                    <textarea id="inputMensagemNps" style="
                          margin-bottom: 0;
                          border: none;
                          line-height: 1.2em;
                          display: none;
                          font-family: Ubuntu;
                        " type="text" rows="1" class="border flex-1 p-2 shadow-inner outline-none bg-gray-50 focus:bg-white"></textarea>
                  </div>
                  <small id="small_observacao" style="color: red; font-size: 11px; display: none">Por favor adicione uma observação</small>
                  <small id="small_nota" style="color: red; font-size: 11px; display: none">Por favor selecione uma nota</small>

                  <button id="enviarFeedback" class="btenviar2" style="
                        margin-top: 20px;
                        user-select: none;
                        background: #1c813c;
                        color: white;
  ...
  <footer>
    <div class="container" id="rodape">
      <div>
        <a href="https://admin01.imobibrasil.net/imobiliarias/inicial.php" title="Inicial"><img src="./img/logo.png" alt="logo-site" /></a>
      </div>
      ...
      <div class="social">
        Siga-nos
        <a href="https://www.facebook.com/imobibrasil" target="_blank" title="Facebook"><i class="fa-brands fa-facebook" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/imobibrasilbr" target="_blank" title="YouTube"><i class="fa-brands fa-youtube" aria-hidden="true"></i></a>
